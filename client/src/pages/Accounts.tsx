...
import AcconuntList from "../components/AcconuntList";
...
<div className="flex flex-col sm:flow-row items-start sm:items-center justify-between gap-4 text-sm">
  <div>
    <h2 className="text-xl text-slate-900">
Connected Accounts
    </h2>
    <p className="text-slate-500 text-sm mt-0.5">{accounts.length} of {PLATFORMS.length} Platform Created </p>
  </div>
...
<AcconuntList accounts={accounts} onDisconnect={handelDisconnect} />
