import { CalculatorIcon, LayoutIcon, LogOutIcon, UserIcon, Wand2Icon } from 'lucide-react'
...
const {logout,user}={
  ...
  const navItem= [
    ...
    {name :'Scheduler',icon :CalculatorIcon,path:"/schedule"},
...
const isActive= location.pathname===item.path;
            ...
            return(
             <NavLink key={index} to={item.path}  end={item.path==="/dashboard"}
